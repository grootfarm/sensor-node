...
const int FAN = 16;                  // TODO: Disable it as it's not used
const int IRRIGATION = 5;            // TODO: Disable it as it's not used
...
void setup(){
  ...
  pinMode(IRRIGATION, OUTPUT);   // TODO: Disable it as it's not used
  pinMode(FAN, OUTPUT);          // TODO: Disable it as it's not used
  digitalWrite(IRRIGATION, LOW); // TODO: Disable it as it's not used
  digitalWrite(FAN, LOW);        // TODO: Disable it as it's not used
...
// TODO: Disable it as it's not used
